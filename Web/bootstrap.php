...
require __DIR__ . '/../lib/ArthyleneFramework/SplClassLoader.php';

// On va ensuite enregistrer les autoloads correspondant à chaque vendor (OCFram, App, Model, etc.)
$OCFramLoader = new SplClassLoader('ArthyleneFramework', __DIR__ . '/../lib');
...
// $appClass = "App\\Api\\ApiApplication";
